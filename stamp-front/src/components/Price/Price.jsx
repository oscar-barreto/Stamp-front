  ...
  return (
    <>
        <div className="m-10 p-10">
            ...
            <h2 className="p-2 m-2 text-4xl text-lime-500 tracking-wide">Quanto Custa?</h2>
                <div className="flex">
                <div className="border-2 bg-gray-50 border-black w-96 rounded-2xl m-4">
                ...
                <div className="flex justify-center items-center">
                    <p className="font-bold tracking-wide text-2xl">ou</p>
                </div>
                <div className="border-2 bg-gray-50 border-black w-96 rounded-2xl m-4">
                    <div className="p-1 m-1 flex justify-between">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 p-1 m-1 border-2 border-black rounded-full">
