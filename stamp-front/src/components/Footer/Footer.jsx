...
const Footer = () => {
  ...
  <div
    ...
    <div className="flex justify-center">
      ...
      <Link to="https://www.instagram.com/stampmarcas/" className="mr-6 text-white hover:text-[#78d64]">
        <svg
      ...
      <Link to="https://wa.me/+558199605252" className="mr-6 text-white">
      <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
                    fill="currentColor"
    ...
    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="">
        ...
        <p className="mb-4" style={{fontFamily:"helvetica"}}>
          <a href="#ComoFunciona" className="text-white" style={{fontFamily:"helvetica"}}
            >Como funciona?</a>
        </p>
        <p className="mb-4" style={{fontFamily:"helvetica"}}>
          <a href="#Porque" className="text-white" style={{fontFamily:"helvetica"}}
            >Por que a Stamp?</a>
        </p>
        <p className="mb-4" style={{fontFamily:"helvetica"}}>
          <a href="#Advantages" className="text-white" style={{fontFamily:"helvetica"}}
            >Vantagens</a>
        </p>
        <p className="mb-4" style={{fontFamily:"helvetica"}}>
          <a href="#Custos" className="text-white" style={{fontFamily:"helvetica"}}
            >Custos</a>
        </p>
