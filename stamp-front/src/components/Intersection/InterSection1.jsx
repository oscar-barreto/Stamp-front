...
const InterSection1 = () => {
  return (
    <>
   <div className="bg-white w-100 flex flex-col md:flex-row-reverse">
            <div className="md:px-20 md:py-20 px-10 py-10">
                <h1 className="text-[--green] md:text-start p-2 m-2 text-5xl" style={{fontFamily:"helvetica"}}>Não abandone os <br /> seus sonhos.</h1>
                <div className="icon-container flex p-1">
                    ...
                    className="h-4 w-4 mx-3 hover:text-amber-700 text-[--green]"
                    fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
