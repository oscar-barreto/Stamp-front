const InterSection2 = () => {
  return (
    <>
        <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 bg-[#f7f7f7]">
            <div className="m-2 p-2">
                <h2 className="m-2 p-2 text-3xl tracking-wide">Registros Inteligentes</h2>
                <div>
                    <p className="m-2 p-2 leading-7 font-light">Em 2020, criamos a Check com o propósito de ajudar microempreendedores e pequenos negócios a proteger um dos maiores ativos de uma empresa: a marca! <br />
