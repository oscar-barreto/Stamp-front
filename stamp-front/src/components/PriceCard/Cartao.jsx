...
const Cartao = () => {
    return (
      <>
          <div className="border-2 sm:my-2 bg-gray-100 border-black w-96 rounded-2xl">
                          ...
                          <div className="">
                              <h2 className="m-2 p-2 text-2xl text-lime-800">Cartao</h2>
                              <p className="m-2 p-2 text-sm">O modo preferido de pagamento dos nossos clientes</p>
                          </div>
                          <div>
                              <h1 className="m-2 p-2 font-bold text-lime-800 text-5xl">R$ 1.250</h1>
                          </div>
