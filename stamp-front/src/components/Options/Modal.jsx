...
if(isOpen) { return (
    ...
    <div className="fixed bg-gray-200 z-2" style={{left:"0",top:"0", right:"0", bottom:'0'}}>
        <div className="fixed top-1/2 left-1/2 w-[400px] sm:w-[700px] p-3 sm:p-5 shadow-lg shadow-gray-400 rounded-xl bg-[#f7f7f7] text-gray-600 font-light" style={{transform:"translate(-50%,-50%)"}}>
                <div>
                    {children}
                </div>
