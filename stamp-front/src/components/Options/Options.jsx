...
const Options = () => {
  ...
  return (
    <>
        ...
        <div className="grid md:grid-cols-4 mx-5 sm:mx-20">
        
        {/* BUTTON ONE */}


        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex flex-col" onClick={()=>setOpenModal(true)}>
        <div className="flex justify-center flex-col items-center">        
        <EyeIcon/>
        <p className="text-center">Oposição à Registro de Marcas</p>
        </div>
        </div>
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-4 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex flex-col" onClick={()=>setOpenModal2(true)}>
        <div className="flex justify-center flex-col items-center">

        <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 my-2 mr-2 text-gray-700">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 3l1.664 1.664M21 21l-1.5-1.5m-5.485-1.242L12 17.25 4.5 21V8.742m.164-4.078a2.15 2.15 0 011.743-1.342 48.507 48.507 0 0111.186 0c1.1.128 1.907 1.077 1.907 2.185V19.5M4.664 4.664L19.5 19.5" />
        </svg>
        <p className="text-center">Manifestação à Oposição ao Registro de Marcas</p>
        </div>
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex justify-center items-center" onClick={()=>setOpenModal3(true)}>
        <div className="flex justify-center flex-col items-center">

        <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 my-2 h-7 mr-2 text-gray-700">
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex justify-center items-center" onClick={()=>setOpenModal4(true)}>
        <div className="flex justify-center flex-col items-center">

        <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" strokeWidth={1.5} stroke="black" className="w-7 h-7 my-2 mb-4 mr-2 text-gray-700">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 001.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 010 3.46" />
        </svg>



        <p className="text-center">Recurso contra Nulidade de Marcas</p>
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex flex-col" onClick={()=>setOpenModal5(true)}>
        <div className="flex justify-center flex-col items-center">        
        ...
        <p className="text-center">Pedido de Caducidade de Marcas</p>
        </div>
        </div>
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-4 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex flex-col" onClick={()=>setOpenModal6(true)}>
        <div className="flex justify-center flex-col items-center">
        ...
        <p className="text-center">Manifestação contra à Caducidade de Marcas</p>
        </div>
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex justify-center items-center" onClick={()=>setOpenModal7(true)}>
        <div className="flex justify-center flex-col items-center">
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex justify-center items-center" onClick={()=>setOpenModal8(true)}>
        <div className="flex justify-center flex-col items-center">
        ...
        <p className="text-center mb-10">Notificação Extrajudicial</p>
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex flex-col" onClick={()=>setOpenModal9(true)}>
        <div className="flex justify-center flex-col items-center"> 

        <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 my-2 text-gray-700">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
        </svg>
        <p className="text-center">Resposta à Notificação Extrajudicial</p>
        </div>
        </div>
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-4 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex flex-col" onClick={()=>setOpenModal10(true)}>
        <div className="flex justify-center flex-col items-center">
        ...
        <p className="text-center mb-6">Naming e Criação de Marca Figurativa</p>
        </div>
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex justify-center items-center" onClick={()=>setOpenModal11(true)}>
        <div className="flex justify-center flex-col items-center">
        ...
        <div className="bg-[--green] text-xl font-medium m-2 p-3 rounded shadow-lg shadow-gray-400 hover:opacity-95 hover:shadow-gray-500 text-[#f7f7f7] flex justify-center items-center" onClick={()=>setOpenModal12(true)}>
        <div className="flex justify-center flex-col items-center">
        ...
        <p className="text-center mb-10">Monitoramento da Marca</p>
        ...
        <h1 className="text-2xl font-medium my-4 tracking-wide text-[--green]">Recurso contra Nulidade de Marcas</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-base tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-2xl font-medium my-4 tracking-wide text-[--green]">Pedido de Caducidade de Marcas</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-base tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-2xl font-medium my-4 tracking-wide text-[--green]">Manifestação contra à Caducidade de Marcas</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-base tracking-wide text-gray-600 font-light">
            ...
            Não hesite em defender sua marca contra a caducidade.             </p>
        </Modal>
        ...
        <h1 className="text-2xl font-medium my-4 tracking-wide text-[--green]">Prorrogação do Registro de Marca</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-base tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-2xl font-medium my-4 tracking-wide text-[--green]">Notificação Extrajudicial</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-base tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-2xl font-medium my-4 tracking-wide text-[--green]">Naming e Criação de Marca Figurativa</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-base tracking-wide text-gray-600 font-light">
            ...
            Seja uma startup ou uma empresa estabelecida, este serviço é essencial para transmitir profissionalismo, confiança e diferenciar-se da concorrência. Conte com a Stamp para assessorar na construção da sua Identidade Visual e destacar sua empresa no mercado.            </p>
        </Modal>
        ...
        <h1 className="text-2xl font-medium my-4 tracking-wide text-[--green]">Pesquisa de Viabilidade</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-base tracking-wide text-gray-600 font-light">
            ...
            Com base em nossa pesquisa detalhada, fornecemos relatórios completos que ajudam você a tomar decisões informadas sobre a escolha de uma marca. Seja para o lançamento de um novo produto, expansão para novos mercados ou renovação de sua estratégia de marca, nossa pesquisa de viabilidade é essencial para garantir que você esteja no caminho certo para o sucesso. 
            </p>       
            </Modal>
        ...
        <h1 className="text-2xl font-medium my-4 tracking-wide text-[--green]">Monitoramento da Marca</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-base tracking-wide text-gray-600 font-light">
