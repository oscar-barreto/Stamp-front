  ...
  return (
    <>
        ...
        <div className="flex flex-col justify-center items-center my-10">
            <h1 className="text-4xl text-center font-semibold text-[--green] my-5">Serviços Stamp:</h1>
            <h2 className="text-xl text-center font-light text-gray-500">Além do registro de marcas na Stamp, nós oferecemos os seguintes serviços:</h2>
        </div>
        ...
        <p className="text-center mb-1">Recurso contra Nulidade de Marcas</p>
        ...
        <p className="text-center mb-4">Naming e Criação de Marca Figurativa</p>
        </div>
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Manifestação à Oposição ao Registro de Marcas</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Pedido de Nulidade de Marcas</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Recurso contra Nulidade de Marcas</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Pedido de Caducidade de Marcas</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Manifestação contra à Caducidade de Marcas</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Prorrogação do Registro de Marca</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-5 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
            ...
            <p className="text-[--green] leading-5 text-sm md:text-base sm:tracking-wide text-gray-600 font-light mt-2">
        ...
        <h1 className="text-xl md:text-2xlfont-medium my-2 md:my-4 tracking-wide text-[--green]">Notificação Extrajudicial</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Resposta à Notificação Extrajudicial</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Naming e Criação de Marca Figurativa</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
        ...
        <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Pesquisa de Viabilidade</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
            ...
            <h1 className="text-xl md:text-2xl font-medium my-2 md:my-4 tracking-wide text-[--green]">Monitoramento da Marca</h1>
            <div className="border-b-2 my-2"></div>
            <p className="leading-6 text-sm md:text-base sm:tracking-wide text-gray-600 font-light">
